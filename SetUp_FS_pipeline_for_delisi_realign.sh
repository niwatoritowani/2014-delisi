...
# freesurfer-pipeline（copy from ${ORG_FS_DIR} to ${NEW_PPL_DIR}/freesurfer-pipeline）
# - realign-edrmasks-pipeline (copy to ${NEW_PPL_DIR}/realign-edrmasks-pipeline)
# - - realign-pipeline (copy to ${NEW_PPL_DIR}/realign-pipeline)
#
...
echo -n ${NEW_PPL_DIR}/realign-edrmasks-pipeline/\$case.t1-realign-masked.nrrd
 > config/T1S_FILEPATTERN
