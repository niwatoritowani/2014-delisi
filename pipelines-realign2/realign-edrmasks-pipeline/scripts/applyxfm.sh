...
fslswapdim $nii RL AP SI $nii > /dev/null
...
fslswapdim $nii_out AP SI LR $nii_out >/dev/null || true # jun added
fslswapdim $nii_out AP SI RL $nii_out >/dev/null || true # jun added
